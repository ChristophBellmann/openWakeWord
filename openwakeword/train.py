...
if __name__ == '__main__':
    ...
    if args.augment_clips is True:
        # Set the total length of the training clips based on the ~median generated clip duration, rounding to
        # the nearest 1000 samples and setting to 32000 when the median + 750 ms is close to that.
        n = 50  # sample size
